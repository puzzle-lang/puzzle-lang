...
object TopLevelContractDeclarationMatcher : TopLevelDeclarationMatcher<ContractDeclaration> {
	...
	context(_: PzlContext)
	override fun parse(ctx: PzlParserContext, modifiers: Set<Modifier>): ContractDeclaration {
